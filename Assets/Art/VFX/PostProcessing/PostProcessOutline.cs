...
public sealed class PostProcessOutline : PostProcessEffectSettings
{
    ...
    public ColorParameter light = new ColorParameter { value = Color.white };
    public ColorParameter dark = new ColorParameter { value = Color.black };
...
public sealed class PostProcessOutlineRenderer : PostProcessEffectRenderer<PostProcessOutline>
{
    public override void Render(PostProcessRenderContext context)
    {
        ...
        sheet.properties.SetColor("_Light", settings.light);
        sheet.properties.SetColor("_Dark", settings.dark);
